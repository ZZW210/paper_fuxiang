...
- `paper_objective_scale_mode`: initial_reference_experimental
- `seed`: 2025
- `NP`: 50
- `Ngen_max_stage1`: 200
- `Ngen_max_stage2`: 200
...
- `stage2_final_conflict_points`: 43
- `changed_flight_count_two_stage`: 69
- `stage1_strategy_combination_count`: 0
- `stage2_strategy_combination_count`: 32
- `final_Tdelay`: 29427.39293706117
- `final_Tair`: 60277.639287096026
- `final_ORISK`: 1136.4509017723265
- `final_n_delay`: 0
- `final_n_battery`: 0
- `final_paper_fitness`: 0.4041609979582652
- `stage1_fata_time`: 143.35655709999992
- `stage2_fata_time`: 142.0786651999988
- `total_runtime`: 292.6714971000001
...
| 指标 | 旧版 | 本次运行 |
|---|---|---|
| 冲突点 | 130 -> 98 -> 32 | 130 -> 98 -> 43 |
| changed | 61 | 69 |
| Tdelay/s | 25188.77 | 29427.39293706117 |
| Stage1 schedule/speed/reroute | 10/0/0 | 8/2/0 |
| Stage2 schedule/speed/reroute | 23/27/1 | 32/42/38 |
